...
public class DataHelper {
    ...
    private static final String TABLE_NAME = "TB_CONTACTS";
    private static final String CREATE = "CREATE TABLE " + TABLE_NAME + "(id INTEGER PRIMARY KEY, name TEXT, tel TEXT, email TEXT)";
    private static final String INSERT = "INSERT INTO " + TABLE_NAME + "(name, tel, email) VALUES (?, ?, ?)";
    ...
    public long Insert(String name, String tel, String email) {
        this.insertStmt.bindString(1, name);
        this.insertStmt.bindString(2, tel);
    ...
    public List<String> SelectAll() {
        ...
        Cursor cursor = this.db.query(TABLE_NAME, new String[]{"id", "name", "tel", "email"}, null, null, null, null, "id");
